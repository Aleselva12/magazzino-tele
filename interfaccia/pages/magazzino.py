"""
maimport tkinter as tk
from tkinter import ttk, messagebox
from typing import List, Dict, Any, Optional
import sys
import os

# Per compatibilità Python
try:
    from typing import Callable
except ImportError:
    from collections.abc import Callableno.py  
...
class MagazzinoPage:
    ...
    def __init__(self, root: tk.Tk, on_back=None) -> None:
        self.root = root
        self.on_back = on_back or (lambda: None)  # Default callback vuoto
